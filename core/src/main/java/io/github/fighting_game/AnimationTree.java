...
public class AnimationTree {
    ...
    public Map<String, Collider> hitColliderMap;
    public Map<String, Collider> bodyColliderMap;
    public Map<String, String> moveSetMap;

    AnimationTree(String name) {
    ...
    private void addBodyCollider(JsonValue collider, String name){
        Collider newCollider = createCollider(collider, "body collider");
        bodyColliderMap.put(name, newCollider);
    }

    private void addHitCollider(JsonValue collider, String name){
        Collider newCollider = createCollider(collider, "hit collider");
        hitColliderMap.put(name, newCollider);
    }

    private Collider createCollider(JsonValue collider, String name){
        ...
        return new Collider(x, y, width, height, isDisabled);
    }
