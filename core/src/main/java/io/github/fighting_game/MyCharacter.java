...
public class MyCharacter extends MyCenteredSprite {
    ...
    MyCharacter(String name, float x, float y, String strTexturePath, boolean flip_h,
        ...
        animationTree = new MyAnimationTree(this.name);
    ...
    MyCharacter(float x, float y, String strTexturePath, boolean flip_h, boolean isLeft){
    ...
    public MyCollider getBodyCollider() {
        return bodyCollider;
    }
    ...
    public void moveUp(Platform platform, MyCharacter enemyChar) {
    ...
    public void collideWithEnemy(MyCharacter enemy) {
